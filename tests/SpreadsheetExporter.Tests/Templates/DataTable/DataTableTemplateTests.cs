...
namespace CloudyWing.SpreadsheetExporter.Tests.Templates.DataTable {
    ...
    internal class DataTableTemplateTests {
        ...
        private DataTableTemplate template = null!;
        ...
        [Test]
        public void GetLayout_NoColumns_ReturnsEmptyCells() {
            template.Columns.Clear();
            TemplateLayout layout = template.GetLayout();

            Assert.That(layout.Cells, Is.Empty);
        }

        [Test]
        public void GetLayout_WithAutoGeneratedColumns_ReturnsCorrectCells() {
            TemplateLayout layout = template.GetLayout();

            // Total cells = (header row + data rows) * columns = (1 + 3) * 3 = 12
            Assert.That(layout.Cells, Has.Count.EqualTo(12));
        }

        [Test]
        public void GetLayout_HeaderCells_HaveCorrectPositions() {
            TemplateLayout layout = template.GetLayout();
            List<Cell> headerCells = layout.Cells.Where(c => c.Point.Y == 0).OrderBy(c => c.Point.X).ToList();
        ...
        [Test]
        public void GetLayout_HeaderCells_HaveCorrectValues() {
            TemplateLayout layout = template.GetLayout();
            List<Cell> headerCells = layout.Cells.Where(c => c.Point.Y == 0).OrderBy(c => c.Point.X).ToList();
        ...
        [Test]
        public void GetLayout_DataCells_HaveCorrectValues() {
            TemplateLayout layout = template.GetLayout();
            var dataCells = layout.Cells.Where(c => c.Point.Y > 0).OrderBy(c => c.Point.Y).ThenBy(c => c.Point.X).ToList();
        ...
        [Test]
        public void GetLayout_WithDBNull_ConvertsToNull() {
            dataTable.Rows.Add(4, DBNull.Value, DBNull.Value);
            template = new DataTableTemplate(dataTable);

            TemplateLayout layout = template.GetLayout();
            var lastRowCells = layout.Cells.Where(c => c.Point.Y == 4).OrderBy(c => c.Point.X).ToList();
        ...
        [Test]
        public void GetLayout_WithCustomHeaderText_UsesCustomText() {
            template.Columns.Clear();
            ...
            TemplateLayout layout = template.GetLayout();
            var headerCells = layout.Cells.Where(c => c.Point.Y == 0).OrderBy(c => c.Point.X).ToList();
        ...
        [Test]
        public void GetLayout_WithFieldValueGenerator_AppliesTransformation() {
            template.Columns.Clear();
            template.Columns.Add(new DataTableColumn {
                ColumnName = "Name",
                HeaderText = "Name",
            ...
            TemplateLayout layout = template.GetLayout();
            var dataCells = layout.Cells.Where(c => c.Point.Y > 0 && c.Point.X == 0).OrderBy(c => c.Point.Y).ToList();
        ...
        [Test]
        public void GetLayout_WithHeaderHeight_SetsCorrectRowHeight() {
            template.HeaderHeight = 20;

            TemplateLayout layout = template.GetLayout();

            Assert.That(layout.RowHeights[0], Is.EqualTo(20));
        }

        [Test]
        public void GetLayout_WithRecordHeight_SetsCorrectRowHeights() {
            template.RecordHeight = 15;

            TemplateLayout layout = template.GetLayout();

            Assert.Multiple(() => {
                Assert.That(layout.RowHeights[1], Is.EqualTo(15));
                Assert.That(layout.RowHeights[2], Is.EqualTo(15));
                Assert.That(layout.RowHeights[3], Is.EqualTo(15));
            });
        }

        [Test]
        public void GetLayout_WithCustomHeaderStyle_AppliesStyle() {
            CellStyle customStyle = new() { Font = new CellFont(Style: FontStyles.Bold) };
            template.Columns.Clear();
            template.Columns.Add(new DataTableColumn {
                ColumnName = "Name",
                HeaderText = "Name",
            ...
            TemplateLayout layout = template.GetLayout();
            var headerCell = layout.Cells.First(c => c.Point.Y == 0);

            Assert.That(headerCell.CellStyleGenerator!(0, 0), Is.EqualTo(customStyle));
        }

        [Test]
        public void GetLayout_WithCustomFieldStyleGenerator_AppliesStyle() {
            CellStyle customStyle = new() { Font = new CellFont(Style: FontStyles.Bold) };
            template.Columns.Clear();
            template.Columns.Add(new DataTableColumn {
                ColumnName = "Age",
        ...
        [Test]
        public void GetLayout_WithFieldFormulaGenerator_AppliesFormula() {
            template.Columns.Clear();
            template.Columns.Add(new DataTableColumn {
                ColumnName = "Age",
                HeaderText = "Age",
