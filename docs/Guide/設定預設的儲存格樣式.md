...
SpreadsheetManager.DefaultCellStyles = new CellStyleConfiguration((setuper) => {
    ...
    setuper.CellStyle = oldCellStyles.CellStyle.CloneAndSetFont(oldCellStyles.CellStyle.Font.CloneAndSetSize(16));
    setuper.GridCellStyle = oldCellStyles.GridCellStyle.CloneAndSetFont(oldCellStyles.GridCellStyle.Font.CloneAndSetSize(14));
    setuper.HeaderStyle = oldCellStyles.HeaderStyle.CloneAndSetFont(oldCellStyles.HeaderStyle.Font.CloneAndSetSize(14));
    setuper.FieldStyle = oldCellStyles.FieldStyle.CloneAndSetFont(oldCellStyles.FieldStyle.Font.CloneAndSetSize(14));
});
```
...
void Initialize() {
    ...
    SpreadsheetManager.DefaultCellStyles = new CellStyleConfiguration((setuper) => 
        ...
        setuper.HeaderStyle = cellStyle.CloneAndSetFont(cellStyle.Font.CloneAndSetStyle(cellStyle.Font.Style | FontStyles.IsBold))
            .CloneAndSetHorizontalAlignment(HorizontalAlignment.Center)
            .CloneAndSetBorder(true);
        setuper.FieldStyle = cellStyle
            .CloneAndSetBorder(true)
            .CloneAndSetHorizontalAlignment(HorizontalAlignment.General);
    });
}
```
