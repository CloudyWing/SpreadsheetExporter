...
internal static class JsonElementExtensions {
    ...
    internal static string GetStringValue(this JsonElement element, JsonParseContext context) {
        return element.ValueKind == JsonValueKind.String
            ? element.GetString()!
            : throw JsonParseExceptionFactory.InvalidType(context, "a JSON string");
    }
    ...
    internal static int GetInt32Value(this JsonElement element, JsonParseContext context) {
        if (element.ValueKind == JsonValueKind.Number && element.TryGetInt32(out int intValue)) {
            return intValue;
        }
        ...
        throw JsonParseExceptionFactory.InvalidType(context, "a 32-bit integer");
    }
    ...
    internal static short GetInt16Value(this JsonElement element, JsonParseContext context) {
        if (element.ValueKind == JsonValueKind.Number && element.TryGetInt16(out short int16Value)) {
            return int16Value;
        }
        ...
        throw JsonParseExceptionFactory.InvalidType(context, "a 16-bit integer");
    }
    ...
    internal static double GetDoubleValue(this JsonElement element, JsonParseContext context) {
        if (element.ValueKind == JsonValueKind.Number) {
            return element.GetDouble();
        }
        ...
        throw JsonParseExceptionFactory.InvalidType(context, "a number");
    }
    ...
    internal static bool GetBooleanValue(this JsonElement element, JsonParseContext context) {
        if (element.ValueKind == JsonValueKind.True) {
            return true;
        }
        ...
        throw JsonParseExceptionFactory.InvalidType(context, "a Boolean");
    }
    ...
    internal static object? ToObject(this JsonElement element, JsonParseContext context) {
        return element.ValueKind switch {
            JsonValueKind.Object => element.ToDictionary(context),
            JsonValueKind.Array => element.EnumerateArray()
                .Select((item, index) => item.ToObject(context.Index(index)))
                .ToList(),
            JsonValueKind.String => element.GetString(),
            JsonValueKind.Number when element.TryGetInt32(out int intValue) => intValue,
            JsonValueKind.Number when element.TryGetInt64(out long longValue) => longValue,
    ...
    internal static Dictionary<string, object?> ToDictionary(this JsonElement element, JsonParseContext context) {
        if (element.ValueKind != JsonValueKind.Object) {
        ...
        Dictionary<string, object?> dictionary = new(StringComparer.Ordinal);
        foreach (JsonProperty property in element.EnumerateObject()) {
            dictionary[property.Name] = property.Value.ToObject(context.Property(property.Name));
        }
