...
/// <summary>
/// Represents a record set column that uses generator delegates for value, formula, style, and validation.
/// </summary>
/// <typeparam name="T">The type of the record.</typeparam>
internal class GeneratorColumn<T> : RecordSetColumnBase<T> {
    /// <summary>
    ...
    private static TResult? GetInternal<TResult>(
