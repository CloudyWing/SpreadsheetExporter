...
namespace CloudyWing.SpreadsheetExporter.Templates.RecordSet {
    /// <summary>The data column base.</summary>
    ...
    public abstract class DataColumnBase<T> {
        ...
        /// <summary>Gets the child columns.</summary>
        ...
        /// <summary>Gets the parent columns.</summary>
        /// <value>The parent columns.</value>
        public DataColumnCollection<T> ParentColumns { get; internal set; }

        /// <summary>Gets the column layers.</summary>
        /// <value>The column layers.</value>
        /// <remarks>自己和子層共幾層 Column，用來計算 RowSpan</remarks>
        ...
        /// <summary>Gets the field formula.</summary>
        /// <param name="context">The context.</param>
