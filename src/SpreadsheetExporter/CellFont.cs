...
namespace CloudyWing.SpreadsheetExporter {
    /// <summary>The cell font.</summary>
    public struct CellFont : IEquatable<CellFont> {
        /// <summary>The cell font equals to <c>new CellFont()</c>.</summary>
        public static CellFont Empty = new();

        /// <summary>Initializes a new instance of the <see cref="CellFont" /> struct.</summary>
        ...
        /// <summary>Gets the color. The default is <c>Color.Empty</c>.</summary>
        ...
        /// <summary>Clones and set the name of new instance.</summary>
        ...
        /// <summary>Clones and set the size of new instance.</summary>
        /// <param name="size">The size.</param>
        /// <returns>The cloned new cell.</returns>
        ...
        /// <summary>Clones and set the color of new instance.</summary>
        /// <param name="color">The color.</param>
        /// <returns>The cloned new cell.</returns>
        ...
        /// <summary>Clones and set the style of new instance.</summary>
        /// <param name="style">The style.</param>
        /// <returns>The cloned new cell.</returns>
