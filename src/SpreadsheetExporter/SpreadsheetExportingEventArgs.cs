...
namespace CloudyWing.SpreadsheetExporter {
    /// <summary>Event arguments before spreadsheet export.</summary>
    public class SpreadsheetExportingEventArgs {
        /// <summary>Initializes a new instance of the <see cref="SpreadsheetExportingEventArgs" /> class.</summary>
